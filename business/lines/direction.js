...
export function lineDirectionForCharacter(settings = {}, key = '') {
    const map = settings.lineDirection;
    return normalizeLineDirection(map && typeof map === 'object' ? map[key] : 'natural');
}
