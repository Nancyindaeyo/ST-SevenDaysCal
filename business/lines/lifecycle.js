export function createLinesLifecycle() {
    ...
    return {
        ...
        get rerollStampDay() { return rerollStampDay; },
        ...
        set rerollStampDay(value) { rerollStampDay = value == null ? null : String(value); },
        ...
        markGenerationStarted({ reroll = false, excludedAssistant = null, stampDay = null, now = Date.now() } = {}) { streamUntil = now + 3000; if (reroll) { pendingReroll = true; rerollExcludedAssistant = excludedAssistant; rerollStampDay = stampDay == null || stampDay === '' ? null : String(stampDay); } },
        consumeRerollStampDay() { const value = rerollStampDay; rerollStampDay = null; return value; },
