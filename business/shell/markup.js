            ...
            <div class="sp-sheet">
                <aside class="sp-sidebar">
                    <nav class="sp-sidebar-tabs" aria-label="主视图" role="tablist" aria-orientation="vertical">
                        ...
                        <button id="sp-tab-slip" class="sp-side-tab sp-view-btn" data-view="slip" role="tab" aria-controls="sp-slip-wrap" aria-selected="false" tabindex="-1">
                                ...
                                <div class="sp-settings-layer-body">
                                    <details class="sp-settings-section" id="sp-axis-section">
                                        ...
                                        <div class="sp-settings-section-body">
                                            ...
                                            <p class="sp-cfg-hint">默认关。每隔几楼用最新正文改走偏的点和线（完成/推迟/改描述，线也可以收束或暂缓），不整表重做。今天事项做完空了，有正文依据会补回真实的今日日期槽。【改】重试也是再对齐，不是重做整张表。冷知识和面不自动改。成功、无变化、失败都记在「改」；失败可按最新楼重试。对齐楼被重 roll 或切 swipe 时默认再对齐一次，不当新楼；手动编辑楼不会触发。时旅那一层两边都不跑。</p>
                                        </div>
                                    </details>
