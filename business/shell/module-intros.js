...
export const MODULE_INTROS = {
    ...
    lamp:
        _iLede('「对账灯」是改账工作台。冲突页提示打架；搜索页按关键词找点／线／面／轴／冷知识／刻度。勾进待改篮，可手改字段、拿到间、或按打架一起改。刷新账本也在这里。') +
        _iSub('间负责想清楚，灯负责按对的提示词改账。一天多个地点不是打架。柏宝书只对照，不回写。跑法没写清可回间再出一版意图。【改】重试仍用当初那一种提示词。') +
