...
export function createTheaterUi({ repository, templates, resolveRegen, draftCap = 10, exporter, feature, host = {} } = {}) {
    ...
    const render = () => {
        ...
        const poolBlock = `<details class="sp-theater-tpl-picker" id="sp-theater-pool-panel"${poolOpen ? ' open' : ''}><summary class="sp-theater-tpl-picker-summary"><i class="fa-solid fa-chevron-right sp-theater-tpl-picker-chevron"></i><span>抽取用世界书</span><span class="sp-theater-tpl-library-count" id="sp-theater-pool-panel-count">${selectedBooks.size}</span></summary><div class="sp-theater-tpl-picker-body sp-theater-pool-panel-body"><p class="sp-cfg-hint">勾选小回 / 极光 / 小兔后，生成 N 条就先跨书抽 N 条条目，再带角色世界书去写。不把整本丢给模型，也不走酒馆预设。</p><input type="search" id="sp-theater-pool-panel-search" class="sp-input sp-wi-exclude-search" placeholder="查找世界书…" value="${attr(state.poolQuery)}"><div id="sp-theater-pool-panel-list" class="sp-wi-exclude-list"><div class="sp-theater-list-empty">加载中…</div></div></div></details>`;
