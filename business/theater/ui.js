...
export function createTheaterUi({ repository, templates, resolveRegen, draftCap = 10, exporter, feature, host = {} } = {}) {
    ...
    const render = () => {
        ...
        const poolBlock = `<details class="sp-theater-tpl-picker" id="sp-theater-pool-panel"${poolOpen ? ' open' : ''}><summary class="sp-theater-tpl-picker-summary"><i class="fa-solid fa-chevron-right sp-theater-tpl-picker-chevron"></i><span>抽取用世界书</span><span class="sp-theater-tpl-library-count" id="sp-theater-pool-panel-count">${selectedBooks.size}</span></summary><div class="sp-theater-tpl-picker-body sp-theater-pool-panel-body"><p class="sp-cfg-hint">只读你勾选的书做抽签，角色卡链接的世界书做背景。不要把小回 / 极光 / 小兔绑到角色卡，也不要在酒馆全局启用。</p><input type="search" id="sp-theater-pool-panel-search" class="sp-input sp-wi-exclude-search" placeholder="查找世界书…" value="${attr(state.poolQuery)}"><div id="sp-theater-pool-panel-list" class="sp-wi-exclude-list"><div class="sp-theater-list-empty">加载中…</div></div></div></details>`;
