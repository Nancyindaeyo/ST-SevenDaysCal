...
export function createBeatFeature(env = {}) {
    ...
    return Object.freeze({
        ...
        onAiFloor: messageId => controller.onAiFloor(messageId),
        onChatChanged: () => controller.onChatChanged(),
        syncFloor: () => controller.syncFloor(),
        bindUi: () => { ui?.bind?.(); controller.syncFloor(); ui?.render?.(); },
        reveal: () => ui?.reveal?.(),
