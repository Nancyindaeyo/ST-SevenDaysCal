...
export function createCoordinateUI({ root = null, onDestroy = null } = {}) {
    const route = { level: 'chars', charName: null, chatId: null, itemId: null, filter: null, shelf: 'snaps', search: '', composer: null, excerptEditId: null, fullTagEdit: false, tagEditId: null, tagEditColor: 'slate', tagNewColor: 'rose', tagDeleteId: null };
    ...
    return {
        ...
        setSearch(next) { route.search = String(next || ''); },
