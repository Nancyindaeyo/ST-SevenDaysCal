...
const itemHay = (item, map) => hayOf([item.charName, item.chatName, item.textPreview, item.searchText, item.note, item.floorIndex, ...tagNamesOf(item.tags, map)]);
