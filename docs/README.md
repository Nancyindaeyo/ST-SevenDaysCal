...
本目录记录构画当前行为、维护约束与后续路线。当前基线版本为 **3.15.8**。
...
- [空 catch 分级](./engineering/empty-catch.md)：critical / best-effort / ignore。
- [CSS 拆分评估](./engineering/css-split.md)：单文件同源输出，不改 SPA，线 Phase 2 前不重写 class。
- [UI 视觉样例](./engineering/ui-visual-samples.html)：日/夜、桌面/窄屏、Shadow/light DOM 令牌对照。
- [项目计划](./项目计划.md) / [项目上下文](./项目上下文.md) / [任务清单](./任务清单.md)：3.15.8 审查后的实施计划、决策和勾选清单。
