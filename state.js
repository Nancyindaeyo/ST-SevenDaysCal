...
export function buildCreativeChatSystemPrompt({ userName, charName, personaDesc = '', authorNote = '', outlineRaw = '', wiContext = '', memText = '', recentCtx = '', almanacText = '', calDescText = '', garnish = '' }) {
    ...
    return [
        ...
        wiContext,
        memText ? `【剧情摘要】以下是已发生剧情的压缩记录（开柏宝书时来自柏宝书摘要，否则来自构画记忆库）。讨论走向或改大纲时优先以此为准。\n${memText}` : '',
        garnish,
